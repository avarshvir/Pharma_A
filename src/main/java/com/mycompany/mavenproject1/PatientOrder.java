 ...
 * @author arshvir
 */
public class PatientOrder extends javax.swing.JFrame {
...
public void getOrder(){
    try{
            String selectStatement = "Select * FROM patientorder";
            PreparedStatement ps = singletonClass.connection.prepareCall(selectStatement);
            ResultSet rs = ps.executeQuery();
            String[] headers = {"medicineId", "medicineName", "genre", "dateOfOrder","price"};
            ...
            while(rs.next()){
                ...
                row[3] = rs.getString("dateOfOrder");
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Medicine ID", "Medicine Name", "Genre", "Date of Order", "Price"
            }
        ));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                ...
                .addGap(270, 270, 270))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addGap(104, 642, Short.MAX_VALUE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PatientOrder.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PatientOrder().setVisible(true);
            }
        });
    }
